...
public class Main {
    public static void main(String[] args) {
        ...
        Cosmetico cosmetico1 = new Cosmetico("Oboticario",54,9000,endereco1,data1,20);
        System.out.println(cosmetico1.toString());

        Vestuario vestuario1 = new Vestuario("Nike",54,9000,endereco1,data1,true);
        System.out.println(vestuario1.toString());

        Bijuteria bijus1 = new Bijuteria("BijuGold",54,9000,endereco1,data1,20);
        System.out.println(bijus1.toString());

        Alimentacao alimentacao1 = new Alimentacao("Sushito",54,9000,endereco1,data1,data1);
        System.out.println(alimentacao1.toString());

        Informatica informatica1 = new Informatica("TerabyteKabum",54,9000,endereco1,data1,543);
